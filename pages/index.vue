<template>
    <main class="flex flex-col min-h-screen overflow-hidden">
        <section class="flex items-center min-h-screen p-6 bg-white dark:bg-gray-900">
            <div class="flex-1 h-full max-w-4xl mx-auto overflow-hidden">
                <div class="max-w-6xl mx-auto px-4 sm:px-6 relative">
                        <div class="text-center">
                            <h1 class="text-5xl md:text-6xl text-gray-900 dark:text-gray-100 font-extrabold leading-tighter tracking-tighter mb-4" >{{$t('title')}} <span class="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-green-400">{{$t('free')}}</span></h1>
                            ...
                            <div class="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
                                <div>
                                    <a class="btn bg-blue-600 hover:bg-blue-700 w-full mb-4 sm:w-auto sm:mb-0" href="#0" style="outline: none;">Start free trial</a>
                                </div>
                                <div>
                                    <a class="btn bg-gray-900 hover:bg-gray-800 dark:bg-gray-800 dark:hover:bg-gray-500 w-full sm:w-auto" :class="$i18n.locale == 'ar' ? 'sm:mr-4' : 'sm:ml-4'" href="#0" style="outline: none;">
                                        View on github
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 512" class="inline-block h-6 ml-2" :class="$i18n.locale == 'ar' ? 'order-first' : 'order-last'" data-v-deda5324=""><path fill="currentColor" d="M186.1 328.7c0 20.9-10.9 55.1-36.7 55.1s-36.7-34.2-36.7-55.1 10.9-55.1 36.7-55.1 36.7 34.2 36.7 55.1zM480 278.2c0 31.9-3.2 65.7-17.5 95-37.9 76.6-142.1 74.8-216.7 74.8-75.8 0-186.2 2.7-225.6-74.8-14.6-29-20.2-63.1-20.2-95 0-41.9 13.9-81.5 41.5-113.6-5.2-15.8-7.7-32.4-7.7-48.8 0-21.5 4.9-32.3 14.6-51.8 45.3 0 74.3 9 108.8 36 29-6.9 58.8-10 88.7-10 27 0 54.2 2.9 80.4 9.2 34-26.7 63-35.2 107.8-35.2 9.8 19.5 14.6 30.3 14.6 51.8 0 16.4-2.6 32.7-7.7 48.2 27.5 32.4 39 72.3 39 114.2zm-64.3 50.5c0-43.9-26.7-82.6-73.5-82.6-18.9 0-37 3.4-56 6-14.9 2.3-29.8 3.2-45.1 3.2-15.2 0-30.1-.9-45.1-3.2-18.7-2.6-37-6-56-6-46.8 0-73.5 38.7-73.5 82.6 0 87.8 80.4 101.3 150.4 101.3h48.2c70.3 0 150.6-13.4 150.6-101.3zm-82.6-55.1c-25.8 0-36.7 34.2-36.7 55.1s10.9 55.1 36.7 55.1 36.7-34.2 36.7-55.1-10.9-55.1-36.7-55.1z" data-v-deda5324=""></path></svg>
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <section class="flex items-center min-h-screen p-6 bg-white dark:bg-gray-900">
            <div class="max-w-screen-xl mx-auto px-6 sm:px-12 lg:px-16 relative">
                <div class="relative pt-6 pb-12">
                    <h3 class="text-center text-3xl leading-8 font-extrabold tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10">
                        {{$t('features.title')}}
                    </h3> 
                ...
                <div>
                    <div class="md:grid md:grid-cols-12 md:gap-24 pb-20 items-center">
                        <div class="text-base leading-6 text-center font-medium text-gray-900 md:col-span-6" :class="$i18n.locale == 'ar' ? 'md:text-right' : 'md:text-left'">
                            <h3 class="text-2xl leading-8 font-extrabold text-gray-900 dark:text-gray-100 sm:text-3xl sm:leading-9">
                                {{$t('features.one')}}
                            </h3> 
                            <p class="text-base leading-6 text-gray-500 pt-3">
                                {{$t('features.onedic')}}
                            </p>
                        </div>
                        <dd class="mt-2 md:mt-0 md:col-span-6">
                            <img src="https://ucarecdn.com/db6e93d4-b102-490a-887f-f228c240ede7/clickandcollect.png" alt="" class="rounded-md shadow-lg">
                        </dd>
                    </div>
                    <div class="md:grid md:grid-cols-12 md:gap-24 pb-20 items-center">
                        <div class="text-base leading-6 text-center font-medium text-gray-900 md:col-span-6" :class="$i18n.locale == 'ar' ? 'md:text-right' : 'md:text-left'">
                        ...
                        <dd class="mt-2 md:mt-0 md:col-span-6">
                            <img src="https://ucarecdn.com/db6e93d4-b102-490a-887f-f228c240ede7/-/format/auto/" alt="" class="rounded-md shadow-lg">
                        </dd>
                    </div>
                    <div class="md:grid md:grid-cols-12 md:gap-24 pb-20 items-center">
                        <div class="text-base leading-6 text-center font-medium text-gray-900 md:col-span-6" :class="$i18n.locale == 'ar' ? 'md:text-right' : 'md:text-left'">
                        ...
                        <dd class="mt-2 md:mt-0 md:col-span-6 text-center">
                            <img src="https://ucarecdn.com/95a551cd-90f5-4d8e-a8c9-3310d04e0729/-/resize/596x/-/format/auto/" alt="" class="rounded-md h-72 mx-auto">
                        </dd>
                    </div>
                </div>
            </div>
        ...
        <section class="relative flex items-center min-h-screen p-6 bg-white dark:bg-gray-900">
            <div class="max-w-screen-xl mx-auto px-6 sm:px-12 lg:px-16 relative">
                <div class="text-center">
                    <h2 class="text-3xl leading-9 tracking-tight font-extrabold text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10">
                        {{$t('blog.title')}}
                    </h2>
                    <p class="mt-4 max-w-3xl mx-auto text-center text-xl leading-7 text-gray-500">
                        {{$t('blog.dic')}}
                ...
                <div class="mt-12 grid gap-5 max-w-lg mx-auto lg:grid-cols-3 lg:max-w-none">
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div class="flex-shrink-0">
                            <img src="https://cdn.storekit.com/wp-content/uploads/2020/04/meal-kit-header-img-1170x472.png" alt="Meal kits" class="h-48 w-full object-cover">
                        </div>
                        <div class="flex-1 bg-white dark:bg-gray-800 p-6 flex flex-col justify-between">
                            <div class="flex-1">
                                <p class="text-sm leading-5 font-medium text-indigo-600">
                                <a href="https://storekit.com/advice/meal-kits/" target="_blank" class="hover:underline">
                                    Article
                                </a>
                                </p>
                                <a href="https://storekit.com/advice/meal-kits/" target="_blank" class="block">
                                <h3 class="mt-2 text-xl leading-7 font-semibold text-gray-900 dark:text-gray-100">
                                    Meal Kits, Recipe Boxes, Produce Boxes – Which Is Right For Me?
                                </h3>
                                <p class="mt-3 text-base leading-6 text-gray-500">
                                    There are three explosive trends which are happening right now among delivery restaurants.
                                </p>
                                </a>
                            </div>
                            <div class="mt-6 flex items-center">
                                <div class="flex-shrink-0">
                                    <a href="#">
                                        <img src="https://s.gravatar.com/avatar/2d9dba392d013f74c9c1db6211236c37?s=480&amp;r=pg&amp;d=https%3A%2F%2Fcdn.auth0.com%2Favatars%2Fbe.png" alt="Ben Larcey Avatar" class="h-10 w-10 rounded-full">
                                    </a>
                                </div>
                                <div :class="$i18n.locale == 'ar' ? 'mr-3' : 'ml-3'">
                                    ...
                                    <div class="flex text-sm leading-5 text-gray-500">
                                        <time datetime="2020-03-16">Apr 29, 2020</time>
                                        <span class="mx-1">
                                            ·
                                        </span>
                                        <span>
                    ...
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div class="flex-shrink-0">
                            <img src="https://cdn.storekit.com/wp-content/uploads/2020/04/pub-1170x472.png" alt="Let pubs deliver" class="h-48 w-full object-cover">
                        </div>
                        <div class="flex-1 bg-white dark:bg-gray-800 p-6 flex flex-col justify-between">
                            <div class="flex-1">
                                <p class="text-sm leading-5 font-medium text-indigo-600">
                                ...
                                <a href="https://storekit.com/advice/let-pubs-deliver/" target="_blank" class="block">
                                    <h3 class="mt-2 text-xl leading-7 font-semibold text-gray-900 dark:text-gray-100">
                                        StoreKit says: let pubs deliver
                                    </h3>
                                    <p class="mt-3 text-base leading-6 text-gray-500">
                                    StoreKit is calling on the government to permit pubs to deliver alcohol.
                                    </p>
                                </a>
                            </div>
                            <div class="mt-6 flex items-center">
                                <div class="flex-shrink-0">
                                    <a href="#">
                                        <img src="https://s.gravatar.com/avatar/2d9dba392d013f74c9c1db6211236c37?s=480&amp;r=pg&amp;d=https%3A%2F%2Fcdn.auth0.com%2Favatars%2Fbe.png" alt="Ben Larcey" class="h-10 w-10 rounded-full">
                                    </a>
                                </div>
                                <div :class="$i18n.locale == 'ar' ? 'mr-3' : 'ml-3'">
                                    <p class="text-sm leading-5 font-medium text-gray-900 dark:text-gray-100">
                                    ...
                                    <div class="flex text-sm leading-5 text-gray-500">
                                        <time datetime="2020-03-16">Apr 23, 2020</time> 
                                            <span class="mx-1">
                                                ·
                                            </span>
                                            <span>
                    ...
                    <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
                        <div class="flex-shrink-0">
                            <img src="https://cdn.storekit.com/wp-content/uploads/2020/03/display-im-storekit-600x242.png.webp" alt="StoreKit's Guide to Ghost Kitchens" class="h-48 w-full object-cover">
                        </div>
                        <div class="flex-1 bg-white dark:bg-gray-800 p-6 flex flex-col justify-between">
                            <div class="flex-1">
                                <p class="text-sm leading-5 font-medium text-indigo-600">
                                    <span class="hover:underline">Guide</span>
                                </p>
                                <a href="https://storekit.com/advice/ghost-kitchen/" target="_blank" class="block">
                                    <h3 class="mt-2 text-xl leading-7 font-semibold text-gray-900 dark:text-gray-100">
                            ...
                            <div class="mt-6 flex items-center">
                                <div class="flex-shrink-0"><span><img src="https://s.gravatar.com/avatar/3daa43bdd93664bcb8d76fde6da428d9?s=480&amp;r=pg&amp;d=https%3A%2F%2Fcdn.auth0.com%2Favatars%2Fad.png" alt="Adam Stead" class="h-10 w-10 rounded-full"></span>
                                </div>
                                <div :class="$i18n.locale == 'ar' ? 'mr-3' : 'ml-3'">
                                    <p class="text-sm leading-5 font-medium text-gray-900 dark:text-gray-100">
                                    ...
                                    <div class="flex text-sm leading-5 text-gray-500">
                                        <time datetime="2020-03-16">Mar 1, 2020</time> 
                                        <span class="mx-1">
                                            ·
                                        </span>  
                                        <span>
                ...
                <div class="w-full mx-auto mt-6">
                    <a href="#0" class="btn font-semibold bg-blue-600 hover:bg-blue-700 w-full mb-4 sm:w-auto sm:mb-0" style="outline: none;">
                        {{$t('blog.more')}}
                    </a>
                </div>
            </div>
...
<style>
.btn {
    @apply font-medium px-8 py-3 shadow-lg inline-flex items-center justify-center border border-transparent rounded leading-snug transition duration-150 ease-in-out text-white
}
</style>
